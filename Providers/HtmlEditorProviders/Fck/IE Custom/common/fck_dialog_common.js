...
function OpenFileBrowser( url, width, height )
{
	...
	if ( oEditor.FCKConfig.PreserveSessionOnFileBrowser && oEditor.FCKBrowserInfo.IsIE )
	{
		...
		// The following line was modified by Mauricio Marquez for the DNN Provider
		// to enhance the IE experience. Remove comments of the above two lines
		// and delete the following code to return to the original code
		...
		// Finish of Mauricio Marquez's modifications
    }
    else
