<%@ Control language="c#" CodeBehind="SummaryItemTemplate.ascx.cs" Inherits="DotNetNuke.Modules.Store.WebControls.SummaryItemTemplate" AutoEventWireup="True" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<itemtemplate>
	<TABLE id="ItemTable" runat="server" cellSpacing="0" cellPadding="0" width="100%" border="0">
		<TR valign="top">
