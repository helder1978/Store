				...
				<table cellspacing="4" cellpadding="0" summary="Security Roles Design Table" border="0">
					...
					<tr>
						<td valign="top" width="160">
							...
							<asp:dropdownlist id="cboUsers" cssclass="NormalTextBox" runat="server" autopostback="True" datavaluefield="UserID" datatextfield="Displayname" width="160"></asp:dropdownlist>
							<asp:dropdownlist id="cboRoles" cssclass="NormalTextBox" runat="server" autopostback="True" datavaluefield="RoleID" datatextfield="RoleName" width="160"></asp:dropdownlist>
						</td>
						<td width="10"></td>
