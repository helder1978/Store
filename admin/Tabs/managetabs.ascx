						...
						<TD vAlign="top" width="475">
							...
							<TABLE id="tblPage" cellSpacing="2" cellPadding="2" summary="Site Details Design Table"
								...
								<TR>
									<TD class="SubHead" vAlign="top" width="150">
										<dnn:label id="plMenu" runat="server" resourcekey="Menu" suffix="?" helpkey="MenuHelp"
											controlname="chkMenu"></dnn:label></TD>
									<TD width="325">
										<asp:checkbox id="chkMenu" runat="server" font-size="8pt" font-names="Verdana,Arial"></asp:checkbox></TD>
								</TR>
								<TR>
                                ...
                                <tr id="rowCopyPerm" runat="server">
                                    ...
                                    <td><asp:LinkButton ID="cmdCopyPerm" runat="server" CssClass="CommandButton" resourcekey="cmdCopyPerm"></asp:LinkButton>
                                    </td>
                                </tr>
							</TABLE>
						</TD>
								...
								<Columns>
									...
									<asp:TemplateColumn>
										<ItemTemplate>
											...
											<asp:RadioButton ID="optReference" Runat="server" CssClass="NormalBold" GroupName="Copy" Text="Reference" resourcekey="ModuleReference" Enabled='<%# DataBinder.Eval(Container.DataItem, "ModuleID") <> -1  %>'>
											</asp:RadioButton>
										</ItemTemplate>
										<ItemStyle Wrap="False"></ItemStyle>
									</asp:TemplateColumn>
						...
						<TD vAlign="top" width="475">
							...
							<TABLE id="tblAppearance" cellSpacing="2" cellPadding="2" summary="Appearance Design Table"
								...
								<tr id="rowCopySkin" runat="server">
								    <td class="SubHead"><dnn:Label ID="plCopySkin" runat="server" ResourceKey="plCopySkin" /></td>
								    <td><asp:LinkButton ID="cmdCopySkin" runat="server" CssClass="CommandButton" resourcekey="cmdCopySkin"></asp:LinkButton>
								    </td>
								</tr>
								<TR>
									<TD class="SubHead" vAlign="top" width="150">
								...
								<TR>
									<TD class="SubHead" width="150">
										<dnn:label id="plRefreshInterval" runat="server" resourcekey="RefreshInterval" suffix=":" helpkey="RefreshInterval.Help"
											controlname="cboRefreshInterval" columns="10"></dnn:label></TD>
									<TD width="325">
							...
							<TABLE id="tblOther" cellSpacing="2" cellPadding="2" summary="Appearance Design Table"
								...
								<TR>
									<TD class="SubHead" vAlign="top" width="150">
										<dnn:label id="plSecure" runat="server" text="Secure?" controlname="chkSecure"></dnn:label></TD>
									<TD>
