...
<%@ Register TagPrefix="dnn" TagName="HELP" Src="~/Admin/Skins/Help.ascx" %>
	<link id="skin" href="<%= SkinPath %>skin.css" type="text/css" rel="stylesheet" />
		    ...
		    <tr>
			    <td colspan="3">
				    <table class="menu" cellspacing="0" cellpadding="0" border="0" style="width:989px">
						...
						<!--    
					            <td align="center" valign="top" runat="server" id="TOPPANE"><dnn:MENU runat="server" id="dnnMENU" /> <dnn:SEARCH runat="server" id="dnnSEARCH" /></td>
							-->    
	...
	<table cellspacing="0" cellpadding="0" border="0" align="center">
		<tr>
		    <td class="flashLeftCorner">&nbsp;</td>
			<td class="flashbackgroundEffect">&nbsp;</td>
			<td class="flashRightCorner">&nbsp;</td>
		</tr>
		<tr>
		    <td style="width:46px;">&nbsp;</td>
			<td>
			    <table width="893px" cellspacing="0" cellpadding="0" border="0" align="center">
				    <tr>
					    <td width="280px" valign="top"  id="LeftPane" runat="server"></td>
						<td style="width:26px;">&nbsp;				</td>
						<td width="280px" valign="top"  id="ContentPane" runat="server">						</td>
						<td style="width:26px;">&nbsp;				</td>
						<td  width="280px" id="RightPane" runat="server">
						</td>
					</tr>
				</table>
			</td>
